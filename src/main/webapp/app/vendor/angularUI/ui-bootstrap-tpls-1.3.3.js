...
angular.module("uib/template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/modal/window.html",
    ...
    "    <div class=\"modal-dialog {{size ? 'modal-' + size : ''}}\"><div class=\"modal-content\" style=\"background: -webkit-linear-gradient(right, rgba(255, 255, 255, 255), rgb(255, 255, 255));\" uib-modal-transclude></div></div>\n" +
    "</div>\n" +
    "");
}]);
